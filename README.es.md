...
> El paquete expone su entrypoint en el subpath `./tui` (`exports["./tui"]`). Si tu versión del loader no resuelve el export por defecto, usa el subpath explícito: `opencode-go-usage-plugin/tui`.
